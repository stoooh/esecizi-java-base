...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String str = "BOttiglia";
        String lowerStr = str.toLowerCase();
        String higherStr = str.toUpperCase();

        System.out.println(lowerStr + " " + higherStr);
    }
    ...
    private static void exercise2() {
        ...
        String strName = firstName.toUpperCase();
        String middleName = "(DROGAAAAAAAAAAAA)";
        String strMiddle = middleName.toLowerCase();
        String lastName = "(stoian)";
        String strSurname = lastName.toUpperCase();



        System.out.println(strName + " " + strMiddle + " " + strSurname); // <--- Edit this line
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "true" + " " + true; // <--- Edit this line
